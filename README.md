...
```js
$ electrum-cli blockchain.transaction.get f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16 true --btc
{ blockhash:
   '00000000d1145790a8694403d4063f323d499e655c83426834d4ce2f8dd4a2ee',
  blocktime: 1231731025,
  confirmations: 663247,
  hash:
  ...
  vin:
   [ { scriptSig: [Object],
       ...
       vout: 0 } ],
  vout:
   [ { n: 0, scriptPubKey: [Object], value: 10 },
     { n: 1, scriptPubKey: [Object], value: 40 } ] }
```

#### Broadcast a transaction on BTC using a custom server
```
$ electrum-cli blockchain.transaction.broadcast  --server btc.litepay.ch:50002
f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16
```

#### List all UTXOs for an address on BCH using a custom version
```js
$ electrum-cli blockchain.address.listunspent bitcoincash:prc3anhlptnca2pc7p8c7700546d5kamgsklagnkrs --bch --version 1.4.3
[ { height: 0,
    tx_hash:
     '26511b1110aa16fcaefd703c8daee5b2e9932559f5cbf234aad57aec879d2029',
    tx_pos: 0,
    value: 21000000 } ]
```
